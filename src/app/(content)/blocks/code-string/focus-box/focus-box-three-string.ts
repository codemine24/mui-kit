export const focusBoxThreeString = `import {
  Box,
  Button,
  Card,
  CardContent,
              ...
              >
                ...
                <CardContent sx={{ zIndex: 5 }}>
                  ...
                  <Typography variant="body1" sx={{ mt: 1 }}>
                    Aliquet adipiscing vivamus ultrices ipsum, commodo vitae,
                    elit nec ipsum luctus. Eget non vitae scelerisque eget
                    sapienre libero, lorem nam quis vitae quis morbi, id
                    consequat mauris massa.
                  </Typography>
                </CardContent>
              </Card>
            </Grid>
