export const testimonialGridQuoteString = `import { Avatar, Box, Container, Stack, Typography } from "@mui/material";
...
export const TestimonialGridQuoteString = () => {
  ...
  return (
    ...
    >
        <Box sx={{ textAlign: "center" }}>
          ...
          >
            <Avatar src={testimonial.avatar} alt={testimonial.name} sx={{ width: 64, height: 64 }} />
