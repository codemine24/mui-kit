export const pricingTableDarkString = `import { Box, Divider, Grid, Typography } from "@mui/material";
...
export const PricingTableDarkPreview = () => {
  return (
    <Box
      sx={{
        position: "relative",
          ...
          <Grid size={{ xs: 12, sm: 6, md: 4 }} key={table.id}>
            <Box
              sx={{
                ...
                color: "common.white",
                border: table.isFeatured
                  ? "2px solid #FFAB00"
                  : "1px solid #444",
                borderRadius: 2,
                boxShadow: table.isFeatured ? 6 : 2,
                p: 3,
                display: "flex",
                flexDirection: "column",
                height: "100%",
            ...
            >
              <Typography
                ...
                fontWeight={600}
                gutterBottom
                color={table.isFeatured ? "#FFAB00" : "common.white"}
              >
                {table.title}
              </Typography>
                ...
                <Box
                  ...
                  sx={{
                    ...
                    backgroundColor: table.isFeatured
                      ? "#FFAB00"
                      : "transparent",
                    color: table.isFeatured ? "#000" : "#FFAB00",
                    border: "1px solid #FFAB00",
                    fontWeight: 600,
                    textDecoration: "none",
                    transition: "0.3s",
                    "&:hover": {
                      backgroundColor: table.isFeatured ? "#ffc233" : "#FFAB00",
                      color: "#000",
                    },
                  }}
                >
