export const newsletterSubscriptionLiquidString = `import WavesIcon from "@mui/icons-material/Waves";
import {
  Box,
  Button,
  Card,
        ...
        >
          ...
          <path
            d={\`M0,\${300 + Math.sin(waveOffset * 0.02) * 50}
                 Q\${250 + Math.cos(waveOffset * 0.03) * 30},\${
              200 + Math.sin(waveOffset * 0.025) * 40
            }
                 \${500 + Math.sin(waveOffset * 0.02) * 20},\${
              250 + Math.cos(waveOffset * 0.03) * 30
            }
        ...
        <Box sx={{ textAlign: "center", mb: { xs: 8, md: 2 } }}>
          ...
          >
            ...
            <Box
              ...
              sx={{
                background:
                  "linear-gradient(90deg, #ec4899 0%, #9333ea 50%, #4f46e5 100%)",
                backgroundClip: "text",
          ...
          >
            Flow with the current of innovation. Our newsletter adapts and
            morphs to deliver exactly what you need, when you need it.
          </Typography>
        </Box>
        {/* Card */}
          ...
          <Card
            sx={{
              ...
              boxShadow: isDark
                ...
                : "0 8px 32px rgba(147,51,234,0.10)",
              border: isDark
            ...
            <CardContent sx={{ p: { xs: 4, md: 2 } }}>
                ...
                >
                  <Box
                    sx={{
                      ...
                      borderRadius: "50%",
                      background:
                        "linear-gradient(90deg, #ec4899 0%, #4f46e5 100%)",
                  ...
                  InputProps={{
                    sx: {
                      ...
                      background: isDark
                        ...
                        : "linear-gradient(90deg, #fce7f3 0%, #e0e7ff 100%)",
                      boxShadow: isDark
                        ? "0 2px 8px rgba(147,51,234,0.10)"
              ...
              <Button
                ...
                sx={{
                  ...
                  "&:hover": {
                    background:
                      "linear-gradient(90deg, #db2777 0%, #7c3aed 50%, #3730a3 100%)",
