export const testimonialJourneyString = `"use client";
      ...
      <Container maxWidth="lg">
        <Grid container spacing={{ xs: 8, lg: 16 }} alignItems="center">
          <Grid size={{ xs: 12, lg: 5 }}>
            <Box mb={6} >
              <Typography variant="h4" fontWeight="light" sx={{ letterSpacing: "-0.5px", color: "text.primary" }}>
                TESTIMONIALS
              </Typography>
            </Box>
            <Box>
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <Avatar
                    ...
                    sx={{ width: 40, height: 40, mr: 2, filter: "grayscale(100%)" }}
                  />
                  <Box>
          ...
          <Grid size={{ xs: 12, lg: 7 }}>
            ...
            >
              ...
              <Rating name="read-only" value={activeTestimonial.rating} readOnly />
            </Box>
          </Grid>
        </Grid>
      </Container>
