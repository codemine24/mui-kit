          ...
          >
            <Stack spacing={5}>
              <Stack spacing={2.5}>
                ...
                >
                  Supercharge your workflow with powerful tools for teams and
                  creators. Organize projects, collaborate in real time, and
                  bring your ideas to life—all in one beautiful workspace.
                </Typography>
              </Stack>
              <Stack
              ...
              >
                ...
                <Typography
                  sx={{ color: "#6b7280", fontSize: 14, fontWeight: 300 }}
                >
