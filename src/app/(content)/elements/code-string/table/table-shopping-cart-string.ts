export const shoppingCartTableString = `import {
    Box,
    Table,
    TableBody,
    TableCell,
...
const initialCart: Product[] = [
    { id: 1, name: "Wireless Mouse", image: "https://via.placeholder.com/50", price: 29.99, quantity: 2 },
    { id: 2, name: "Bluetooth Headphones", image: "https://via.placeholder.com/50", price: 59.99, quantity: 1 },
    { id: 3, name: "Laptop Stand", image: "https://via.placeholder.com/50", price: 19.99, quantity: 3 },
    { id: 4, name: "Webcam", image: "https://via.placeholder.com/50", price: 39.99, quantity: 1 },
    { id: 5, name: "USB-C Hub", image: "https://via.placeholder.com/50", price: 24.99, quantity: 2 },
    { id: 6, name: "AirPods", image: "https://via.placeholder.com/50", price: 199.99, quantity: 1 },
    { id: 7, name: "Smartphone", image: "https://via.placeholder.com/50", price: 399.99, quantity: 1 },
    { id: 8, name: "Smartwatch", image: "https://via.placeholder.com/50", price: 199.99, quantity: 1 },
];
