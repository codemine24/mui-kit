export const comparisonTableString = `import {
    Box,
    Table,
    TableBody,
    TableCell,
        ...
        <Paper sx={{ width: "100%", overflowX: "auto" }}>
            <TableContainer>
                <Table sx={{ minWidth: 650 }} aria-label="comparison table">
                    <TableHead>
                        <TableRow>
                            <TableCell><Typography variant="h6">Feature</Typography></TableCell>
                            <TableCell align="center"><Typography variant="h6">Monthly Plan</Typography></TableCell>
                            <TableCell align="center"><Typography variant="h6">Yearly Plan</Typography></TableCell>
                        </TableRow>
                    </TableHead>
                    <TableBody>
