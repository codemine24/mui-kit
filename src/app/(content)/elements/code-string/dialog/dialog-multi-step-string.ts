...
export const DialogMultiStep = () => {
    ...
    const StepContent = () => {
        switch (activeStep) {
            case 0:
                return (
                    <Box>
                        <Typography variant="h6" gutterBottom>My Information</Typography>
            ...
            case 1:
                return (
                    <Box>
                        <Typography variant="h6" gutterBottom>My Experience</Typography>
                        <TextField
                            required
                            fullWidth
                            multiline
            ...
            case 2:
                return (
                    <Box>
                        <Typography variant="h6" gutterBottom>Application Questions</Typography>
                        <TextField
                            required
                            fullWidth
                            multiline
    ...
    return (
        <Fragment>
            <Button variant="contained" onClick={() => setOpen(true)}>Open Multi Step Dialog</Button>
