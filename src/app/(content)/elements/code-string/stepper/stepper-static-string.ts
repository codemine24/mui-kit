    ...
    return (
        <Box sx={{ width: '100%' }}>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 2, mt: 4 }}>
                <Button variant="outlined" disabled={activeStep === 0} onClick={handleBack}>Previous</Button>
                <Button variant="contained" disabled={isLastStep() && !allStepsCompleted()} onClick={handleNext}>Next</Button>
            </Box>
        </Box>
    );
}
