...
export const PopoverPosition2Preview = () => {
  ...
  const [centerCenterAnchor, setCenterCenterAnchor] = React.useState<HTMLButtonElement | null>(
    null
  );
  ...
  return (
    <div>
      <Stack direction="row" flexWrap="wrap" rowGap={2} spacing={2}>
        <Button
          aria-describedby="popover-center-left"
          variant="contained"
          onClick={handleCenterLeftClick}>
          Center Left
        </Button>
        <Button
          aria-describedby="popover-center-right"
          variant="contained"
          onClick={handleCenterRightClick}>
          Center Right
        </Button>
        <Button
          aria-describedby="popover-center-center"
          variant="contained"
          onClick={handleCenterCenterClick}>
          Center Center
        </Button>
      </Stack>
