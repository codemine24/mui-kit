...
import { Carousel, IndexLabel, CarouselArrowBasicButtons } from '../components';
...
export function CarouselAutoHeight() {
    ...
    return (
        <Box width="100%">
            ...
            <Carousel mainRef={emblaRef} options={options} sx={{ borderRadius: 2, height: 'auto' }} slotProps={{ slide: { height: 'auto' } }}>
                {data.map((item, index) => (
