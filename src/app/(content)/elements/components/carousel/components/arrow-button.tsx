...
import type { CarouselOptions, CarouselArrowButtonProps } from '../types/type';
...
export function ArrowButton({
    ...
    return (
        <ArrowButtonRoot
            ...
            {...other}
        >
            <SvgIcon className={className} sx={{ width: svgSize, height: svgSize }}>
                {svgContent}
            </SvgIcon>
        </ArrowButtonRoot>
    );
...
const ArrowButtonRoot = styled(ButtonBase, {
    ...
    variants: [
        ...
        {
            props: { axis: 'y' },
            // style: { [`& .${className}`]: { transform: 'rotate(90deg)' } },
        },
        {
            props: { direction: 'rtl' },
            // style: { [`& .${className}`]: { transform: 'scaleX(-1)' } },
        },
    ],
}));
