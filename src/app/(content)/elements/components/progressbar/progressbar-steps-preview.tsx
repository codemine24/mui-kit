                ...
                {Array.from({ length: totalSteps }).map((_, i) => (
                    <Box
                        ...
                        sx={{
                            ...
                            height: 8,
                            backgroundColor:
                                i < completedSteps ? color : `${color}33`,
...
export const ProgressbarStepsPreview = () => {
    return (
        <Stack width={['100%', '80%']} spacing={2}>
            ...
            <StepProgressBar stepSize={[50, 100]} totalSteps={5} completedSteps={2} showPercentEnd />
            <StepProgressBar stepSize={[60, 90]} totalSteps={5} completedSteps={3} showCheckOnComplete label="Label" />
            <StepProgressBar stepSize={[55, 95]} totalSteps={5} completedSteps={5} showPercentEnd showCheckOnComplete />
        </Stack>
    );
};