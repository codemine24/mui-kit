        ...
        <Box
          ...
          <Box sx={{ p: 3, width: { xs: "100%", md: "50%" }, order: { xs: 2, md: 1 } }}>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
              Subscribe to get promos and messages from Canva about all three good things you can
              unleash—like anything in Fromt Professional!
            </Typography>
            ...
            <Stack spacing={1.5} sx={{ mb: 3 }}>
              ...
              <Box sx={{ display: "flex", alignItems: "flex-start" }}>
                ...
                <Typography variant="body2">Top-trending templates</Typography>
              </Box>
              ...
              <Box sx={{ display: "flex", alignItems: "flex-start" }}>
                ...
                <Typography variant="body2">Recommended templates just for you</Typography>
              </Box>
              ...
              <Box sx={{ display: "flex", alignItems: "flex-start" }}>
                ...
                <Typography variant="body2">Canva&apos;s professional web marketing</Typography>
              </Box>
            </Stack>
