...
export function SwapGridPreview() {
  ...
  const getNewIndex = ({
    ...
    overIndex
  }: NewIndexGetter["arguments"]) => arraySwap(currentItems, currentIndex, overIndex).indexOf(id);
  ...
  return (
    <Box sx={[{ display: "flex", alignItems: "flex-end", flexDirection: "column", width: "100%" }]}>
