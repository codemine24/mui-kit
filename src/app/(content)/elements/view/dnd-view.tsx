...
const sections = [
  {
    ...
    title: "Sortable grid",
    description:
      "When you move the grid, other grids are also adjust their position. ",
    codeString: [
  ...
  },
  {
    ...
    description:
      "Sortable grid with an overlay that follows the cursor. Try moving a grid item.",
    codeString: [
  ...
  },
  {
    ...
    title: "Swap grid",
    description:
      "Only two grid will swap their position and other grids are not affected.",
    codeString: [
  ...
  },
  {
    ...
    title: "Vertical grid",
    description:
      "Vertical draggable grid. You can change the grid position vertically.",
    codeString: [
  ...
  },
  {
    ...
    description:
      "Use this horizontal draggable grid variant with auto scroll. ",
    codeString: [
