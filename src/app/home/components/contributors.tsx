  ...
  return (
    <Box
      ...
      <Container maxWidth={"xl"}>
        <Box mb={4}>
          <Heading2 text="Community Contributors" sx={{ textAlign: "center" }} />
          <BodyText
            text={
              <>
                Here are the hand-picked contributors who had huge contribution in MUI Kit. If you
                are an open-source enthusiast and want to contribute, you can find us on{" "}
                <Link
